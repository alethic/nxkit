...
namespace NXKit
{
    ...
    /// </summary>
    public static class NXAttributeExtensions
    {
        ...
        /// <returns></returns>
        static XNamespace GetDefaultNamespace(NXAttribute attribute)
        {
        ...
        /// <param name="attribute"></param>
        /// <returns></returns>
        public static XName FullyQualifiedName(this NXAttribute attribute)
        {
        ...
        /// <param name="attribute"></param>
        /// <returns></returns>
        public static XName ValueAsXName(this NXAttribute attribute)
        {
