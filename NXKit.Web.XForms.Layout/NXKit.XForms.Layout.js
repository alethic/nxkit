...
(function (NXKit) {
    (function (Web) {
        (function (XForms) {
            var LayoutVisualViewModel = (function (_super) {
                __extends(LayoutVisualViewModel, _super);
                function LayoutVisualViewModel(context, visual) {
                    _super.call(this, context, visual);
                }
                return LayoutVisualViewModel;
            })(NXKit.Web.XForms.XFormsVisualViewModel);
            XForms.LayoutVisualViewModel = LayoutVisualViewModel;
