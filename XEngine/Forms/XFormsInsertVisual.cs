...
namespace XEngine.Forms.XForms
{
    ...
    [VisualTypeDescriptor(Constants.XForms_1_0_NS, "insert")]
    public class XFormsInsertVisualTypeDescriptor : VisualTypeDescriptor
    {

        public override Visual CreateVisual(IFormProcessor form, StructuralVisual parent, XNode node)
        {
            return new XFormsInsertVisual(parent, (XElement)node);
        }
    ...
    public class XFormsInsertVisual : XFormsNodeSetBindingVisual, IActionVisual
    {
        ...
        internal XFormsInsertVisual(StructuralVisual parent, XElement element)
            : base(parent, element)
        {
        ...
        public void Invoke()
        {
            ...
            var nodeSetVisuals = Module.Form.RootVisual
                .Descendants(true)
