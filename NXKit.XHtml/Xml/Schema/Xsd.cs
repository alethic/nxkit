...
namespace NXKit.XHtml.Xml.Schema
{
    ...
    public static partial class Xsd
    {
        ...
        static readonly Uri relativeUri = new Uri("assembly://NXKit.XHtml/NXKit/XHtml/Xml/Schema/");
        ...
        static XmlSchemaSet LoadXmlSchemaSet()
        {
            ...
            builder.Add(LoadXmlSchema(new Uri(relativeUri + "xhtml1-strict.xsd"), resolver));
            return builder.Build();
        }

        /// <summary>
        /// Gets a reference to the XHTML <see cref="XmlSchemaSet"/>.
        /// </summary>
