...
namespace NXKit.XForms.View.Web.UI
{
        ...
        IViewInjector
    {
        ...
        public void OnPreRender(NXKit.Web.UI.View view)
        {
            ...
            {
                sb.AppendLine(@"(_NXKit.Web.UI.defines['nxkit-xforms'] = $.Deferred()).resolve(window['NXKit']);");
            }

            if (view.EnableEmbeddedStyles)
            {
                var link = new HtmlLink();
                link.Href = view.Page.ClientScript.GetWebResourceUrl(typeof(ViewModuleInjector), "NXKit.XForms.View.Web.UI.Contents.nxkit-xforms.css");
                link.Attributes["rel"] = "stylesheet";
                link.Attributes["type"] = "text/css";
                link.Attributes["data-nx-require"] = "css!nxkit-xforms.css";
                view.Page.Header.Controls.Add(link);

                sb.AppendLine(@"(_NXKit.Web.UI.defines['nxkit-xforms.css'] = $.Deferred()).resolve($('" + link.ClientID + @"')[0]);");
            }
