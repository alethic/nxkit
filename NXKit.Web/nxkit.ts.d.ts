...
declare module NXKit.Web {
    class ViewDeferredTuple {
        public callback: (promise: JQueryDeferred<void>) => void;
        public deferred: JQueryDeferred<void>;
        constructor(cb: (deferred: JQueryDeferred<void>) => void);
        public Promise : JQueryPromise<void>;
    }
    class ViewDeferred {
        static _queue: ViewDeferredTuple[];
        static Push(cb: (promise: JQueryDeferred<void>) => void): void;
        static Wait(cb: () => void): void;
    }
}
